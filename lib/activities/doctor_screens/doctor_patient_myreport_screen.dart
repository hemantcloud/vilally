...
class Doctor_Patient_MyReport extends StatefulWidget {
  const Doctor_Patient_MyReport({Key? key}) : super(key: key);

  @override
  _Doctor_Patient_MyReportState createState() => _Doctor_Patient_MyReportState();
}

class _Doctor_Patient_MyReportState extends State<Doctor_Patient_MyReport>{
